...
const s = StyleSheet.create({
  page: { padding: 32, fontSize: 9, color: DOC.text, fontFamily: "Helvetica" },
  pruebaName: { fontSize: 15, fontFamily: "Helvetica-Bold", color: DOC.navy, marginBottom: 2 },
  ...
  metaLabel: { color: DOC.muted, fontSize: 7, marginBottom: 2 },
  metaValue: { fontSize: 11, fontFamily: "Helvetica-Bold", color: DOC.navy },
  section: { fontSize: 10, fontFamily: "Helvetica-Bold", color: DOC.navy, marginBottom: 4, marginTop: 6 },
  thead: {
    flexDirection: "row",
    backgroundColor: DOC.light,
    paddingVertical: 4,
    paddingHorizontal: 4,
    borderTopWidth: 1,
    borderTopColor: DOC.border,
  },
  th: { fontFamily: "Helvetica-Bold", fontSize: 8, color: DOC.muted },
  row: {
    flexDirection: "row",
    borderBottomWidth: 1,
  ...
  noteLine: { fontSize: 7, color: DOC.muted, marginTop: 1 },
  signRow: { flexDirection: "row", gap: 12, marginTop: 28 },
  signCell: { flex: 1 },
  signLine: { borderTopWidth: 1, borderTopColor: DOC.text, paddingTop: 4 },
  signRole: { fontSize: 9, color: DOC.muted, fontFamily: "Helvetica-Bold" },
        ...
        {items.length > 0 ? (
          items.map((it, i) => (
            <View key={i} style={s.row} wrap={false}>
              ...
              <Text style={[s.cRes, { color: RESULT_COLOR[it.result] ?? DOC.muted }]}>
